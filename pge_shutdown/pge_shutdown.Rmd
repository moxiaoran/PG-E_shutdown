...
# pge close location
pge <- st_read("https://github.com/moxiaoran/PG-E_shutdown/blob/master/data/cali_comp.csv")
pal <- colorNumeric(palette = rcartocolor::carto_pal(7, "PinkYl") , NULL)
# CA zip population
cali_comp <- read_sf("https://github.com/moxiaoran/PG-E_shutdown/blob/master/data/cali_comp.gpkg")
cali_df <- read_csv("https://github.com/moxiaoran/PG-E_shutdown/blob/master/data/cali_comp.csv")
